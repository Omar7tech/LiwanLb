        ...
        <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
            ...
            <div className="px-4 py-5">
                <motion.div
                    ...
                    className="relative z-10 mx-auto mb-6 md:mb-8"
                >
                    <div className="flex items-center justify-center">
                        <img
                            src="/images/logo.png"
                            alt="Liwan Architect Logo"
                            className="h-40 w-auto sm:h-40 md:h-46 lg:h-52"
                        />
                    </div>
                </motion.div>
                ...
                >
                    With AI, you can launch your website in hours, not days. Try
                    our best in class, state of the art, cutting edge AI tools
                ...
                >
                    <button className="w-60 transform rounded-lg bg-warning px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
                        Explore Now
                    </button>
