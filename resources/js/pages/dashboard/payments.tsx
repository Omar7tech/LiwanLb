            ...
            >
                ...
                {projects && projects.length > 0 ? (
                    <motion.div
                        ...
                        className="space-y-3"
                    >
                        <h2 className="text-lg font-semibold text-gray-900 mb-3">Projects with Payment Information</h2>
                                ...
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                    <div className="flex-1">
                                        <div className="flex items-start gap-3">
                                            <div className="p-1.5 bg-[#f2ae1d]/10 rounded-lg">
                                                <FileSpreadsheet className="h-4 w-4 text-[#f2ae1d]" />
                                            </div>
                                            <div className="flex-1">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2">
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 bg-[#f2ae1d] text-white px-3 py-1.5 rounded-lg font-medium hover:bg-[#e09e0d] transition-colors text-sm"
                                        >
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-2 bg-gray-900 text-white px-3 py-1.5 rounded-lg font-medium hover:bg-black transition-colors text-sm"
                                        >
                                            View Project
                                        </Link>
                                    </div>
                    ...
                    >
                        ...
                        <h3 className="text-base font-medium text-gray-900 mb-2">No Payment Information Available</h3>
