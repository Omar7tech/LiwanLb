                ...
                {hasReview && review ? (
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-semibold text-gray-900">Your Current Feedback</h2>
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-2xl font-bold text-[#f2ae1d]">{review.rating}</span>
                        ...
                        {review.review_notes && (
                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                                <div className="flex items-start gap-3">
                                    <MessageSquare size={18} className="text-[#f2ae1d] mt-0.5 shrink-0" />
                                    <p className="text-gray-700 leading-relaxed">{review.review_notes}</p>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <motion.button
                                ...
                                className="flex items-center gap-2 px-6 py-3 bg-[#f2ae1d] text-white rounded-lg hover:bg-[#d4941a] transition-colors duration-200"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.02 }}
                            >
                                <Edit size={18} />
                                <span className="font-medium">Update Feedback</span>
                            </motion.button>
                        </div>
                    </motion.div>
                ) : (
                    ...
                    >
                        ...
                        <motion.button
                            onClick={() => setIsModalOpen(true)}
                            className="inline-flex items-center gap-2 px-6 py-3 bg-[#f2ae1d] text-white rounded-lg hover:bg-[#d4941a] transition-colors duration-200"
                            whileTap={{ scale: 0.95 }}
                            whileHover={{ scale: 1.02 }}
                        >
                            <Edit size={16} />
                            <span className="font-medium">Add Your First Feedback</span>
                        </motion.button>
                    </motion.div>
                )}
            </motion.div>
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            transition={{ duration: 0.2 }}
                            className="bg-white rounded-lg border border-gray-200 max-w-md w-full"
                            ...
                            <form onSubmit={handleSubmit} className="p-6">
                                <div className="mb-6">
                                    ...
                                    >
                                        <span className="inline-flex items-center gap-2 px-3 py-1 bg-gray-100 rounded-full">
                                            <span className="font-medium text-[#f2ae1d] text-sm">{data.rating}/5</span>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <motion.button
                                        type="submit"
                                        disabled={processing}
                                        className="flex-1 px-4 py-2 bg-[#f2ae1d] text-white rounded-md hover:bg-[#d4941a] disabled:opacity-50 transition-colors text-sm font-medium flex items-center justify-center gap-2"
                                        whileTap={{ scale: 0.95 }}
                                    >
                                        {processing ? (
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <motion.button
                                        ...
                                        disabled={isDeleting}
                                        className="flex-1 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 disabled:opacity-50 transition-colors text-sm font-medium flex items-center justify-center gap-2"
                                        whileTap={{ scale: 0.95 }}
                                    >
                                        {isDeleting ? (
                                            <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
